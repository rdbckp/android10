...
#include "nt36525b_boe_a02_param.h"
#include "dd.h"
...
static int nt36525b_boe_read_id(struct lcd_info *lcd, bool need_lock)
{
	int i, ret = 0;
...
static int nt36525b_boe_read_init_info(struct lcd_info *lcd, bool need_lock)
{
	int ret = 0;
	...
	nt36525b_boe_read_id(lcd, need_lock);
...
static int nt36525b_boe_init(struct lcd_info *lcd)
{
	...
	nt36525b_boe_read_init_info(lcd, false);
...
static int nt36525b_boe_probe(struct lcd_info *lcd)
{
	...
	nt36525b_boe_read_init_info(lcd, true);
